...
class Day24(var inputList: List<String>) {
    ...
    fun part1(): String {
        val res: Int
        elapsed1 = measureTimeMillis { res = findPath(NodeId(start,0), NodeId(end,-1)) }
        println("number of iterations: $iterCount")
        return res.toString()
    }
    ...
    fun part2(): String {
        var res: Int
        elapsed2 = measureTimeMillis { res = findPath(NodeId(start,0), NodeId(end,-1)) }
        println("\n\tres1 $res, number of iterations: $iterCount")
        elapsed2 += measureTimeMillis { res = findPath(NodeId(end, res), NodeId(start,-1)) }
        println("\tres2 $res, number of iterations: $iterCount")
        elapsed2 += measureTimeMillis { res = findPath(NodeId(start, res), NodeId(end, -1)) }
        println("\tres3 $res, number of iterations: $iterCount")
        return res.toString()
    }
