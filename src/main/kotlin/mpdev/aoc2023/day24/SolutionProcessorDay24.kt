...
import mpdev.aoc2023.day24.Day24.Companion.end
import mpdev.aoc2023.day24.Day24.Companion.start
import mpdev.aoc2023.day24.Day24.NodeId
...
class SolutionProcessorDay24: SolutionProcessor<Day24> {
    ...
    /** part 1 calculation */
    override fun part1(puzzle: Day24): Pair<String,Long> {
        val res: Int
    ...
    /** part 2 calculation */
    override fun part2(puzzle: Day24): Pair<String,Long> {
        var res: Int
